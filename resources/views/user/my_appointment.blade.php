        ...
        <div align="center" style="padding: 70px;">
            ...
            <table>
                <tr style="background-color: black;">
                    <th style="padding: 10px; font-size:20px; color:white">Repair type</th>
                ...
                @foreach ($appoint as $appoints)
                  ...
                  <tr style="background-color: lightSlategrey" align="center">
                    <td style="padding: 10px;  color:white">{{$appoints->problem}}</td>
                    ...
                    <td><a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')" href="{{url('cancel_appoint',$appoints->id)}}">Cancel</a></td>
                  </tr>
